...
async def warmup_models():
    ...
    # 使用现有的音频文件
    audio_file_path = "test_audio/audio.mp3"  # 使用当前目录下的audio.mp3文件
...
if __name__ == "__main__":
    ...
    print(f"启动STT服务，端口: {port}")
    uvicorn.run("finaltest-api:app", host="0.0.0.0", port=port, reload=True, root_path=root_path)