...
class CosyVoiceFrontEnd:
    ...
    def __init__(self,
        ...
        print("=== CAMPPlus Model Specs ===")
        for i, input_meta in enumerate(self.campplus_session.get_inputs()):
            print(f"Input {i}:")
        ...
        print("=== Speech Tokenizer Model Specs ===")
        for i, input_meta in enumerate(self.speech_tokenizer_session.get_inputs()):
            print(f"Input {i}:")
            print(f"  Name: {input_meta.name}")
            print(f"  Shape: {input_meta.shape}")
            print(f"  Type: {input_meta.type}")
